...
export class PedidoVenda {
     ...
     * 
     * @param {PedidoVenda} pedido_venda- Objeto contendo os dados do carro que será cadastrado. O objeto `Carro`
    ...
    static async cadastroPedidoVenda(pedidoVenda: PedidoVenda): Promise<boolean> {
        try {
            ...
            const queryInsertPedidoVenda = `INSERT INTO pedido_venda (id_cliente, id_carro, data_pedido, valor_pedido)
                                        VALUES 
